	...
	array(
		'fill_data' => array(
			...
			"
				...
				(8, 'page_aside_content', '<h3>Page Aside</h3><div>Treść tej sekcji znajduje się w module <b>Konfiguracja</b> w kluczu <b>page_aside_content</b>.</div>', 'treść w sekcji bocznej strony', 2, 1, :save_time),
				(9, 'page_footer', '<ul class=\"list-inline mb-2\">\r\n  <li class=\"list-inline-item\">\r\n    <a href=\"/?route=page&id=3\">O systemie</a>\r\n  </li>\r\n  <li class=\"list-inline-item\">⋅</li>\r\n  <li class=\"list-inline-item\">\r\n    <a href=\"/?route=contact\">Kontakt</a>\r\n  </li>\r\n  <li class=\"list-inline-item\">⋅</li>\r\n  <li class=\"list-inline-item\">\r\n    <a href=\"/?route=page&id=4\">Regulamin</a>\r\n   </li>\r\n   <li class=\"list-inline-item\">⋅</li>\r\n   <li class=\"list-inline-item\">\r\n     <a href=\"/?route=page&id=5\">Polityka prywatności</a>\r\n   </li>\r\n  <li class=\"list-inline-item\">⋅</li>\r\n  <li class=\"list-inline-item\">\r\n    <a href=\"/?route=statistics\">Statystyki</a>\r\n  </li>\r\n</ul>\r\n', 'treść w stopce strony', 2, 1, :save_time),
				(10, 'page_template_index', 'index', 'szablon strony głównej (nazwa templatki i stylu)', 1, 1, :save_time),
				(11, 'page_template_default', 'default', 'domyślny (nawigacja i treść) szablon strony (nazwa templatki i stylu)', 1, 1, :save_time),
				(12, 'page_template_extended', 'extended', 'rozszerzony (nawigacja, kategorie i treść) szablon strony (nazwa templatki i stylu)', 1, 1, :save_time),
				(13, 'page_template_admin', 'admin', 'administracyjny (tylko treść) szablon strony (nazwa templatki i stylu)', 1, 1, :save_time),
				...
				(15, 'social_links_visible', 'true', 'ikony społecznościowe widoczne', 3, 1, :save_time),
				(16, 'social_buttons', '<span class=\"distance\"></span><span class=\"st_twitter\" displayText=\"&nbsp;\" st_url=\"{{_url_}}\" st_title=\"{{_title_}}\" title=\"Udostępnij na Twitterze\"></span><span class=\"st_googleplus\" displayText=\"&nbsp;\" st_url=\"{{_url_}}\" st_title=\"{{_title_}}\" title=\"Udostępnij w Google+\"></span><span class=\"st_facebook\" displayText=\"&nbsp;\" st_url=\"{{_url_}}\" st_title=\"{{_title_}}\" title=\"Udostępnij na Facebooku\"></span><span class=\"st_linkedin\" displayText=\"&nbsp;\" st_url=\"{{_url_}}\" st_title=\"{{_title_}}\" title=\"Udostępnij w LinkedIn\"></span>', 'przyciski społecznościowe w paskach tytułu artykułów', 2, 1, :save_time),
				(17, 'social_buttons_visible', 'false', 'przyciski społecznościowe widoczne', 3, 1, :save_time),
				(18, 'skip_bar_visible', 'false', 'pasek nawigacji między artykułami widoczny', 3, 1, :save_time),
				(19, 'links_panel_visible', 'true', 'panel górny z linkami widoczny', 3, 1, :save_time),
				(20, 'search_panel_visible', 'true', 'panel wyszukiwania na stronie widoczny', 3, 1, :save_time),
				(21, 'navbar_panel_visible', 'true', 'górny panel nawigacji widoczny', 3, 1, :save_time),
				(22, 'categories_panel_visible', 'false', 'boczny panel nawigacji widoczny', 3, 1, :save_time),
				(23, 'path_panel_visible', 'false', 'panel ze scieżką strony widoczny', 3, 1, :save_time),
				(24, 'logged_panel_visible', 'false', 'panel z nazwiskiem zalogowanego usera widoczny', 3, 1, :save_time),
				(25, 'options_panel_visible', 'true', 'panel menu kontekstowego widoczny', 3, 1, :save_time),
				(26, 'aside_panel_visible', 'false', 'panel sekcji bocznej strony widoczny', 3, 1, :save_time),
				(27, 'options_panel_border', 'false', 'menu kontekstowe w dedykowanym panelu', 3, 1, :save_time),
				(28, 'articles_pagination_enabled', 'false', 'paginacja artykułów wyświetlanej kategorii włączona', 3, 1, :save_time),
				(29, 'articles_per_page', '4', 'liczba artykułów wyświetlanej kategorii na stronę w paginacji', 1, 1, :save_time),
				(30, 'comments_panel_visible', 'false', 'panel z komentarzami do artykułu widoczny', 3, 1, :save_time),
				(31, 'moderate_comments', 'false', 'wymagane moderowanie komentarzy - widoczne po akceptacji', 3, 1, :save_time),
				(32, 'display_list_rows', '10', 'liczba wierszy listy na jednej stronie', 1, 1, :save_time),
				(33, 'description_length', '50', 'maksymalna długość opisu pozycji na liście znalezionych', 1, 1, :save_time),
				(34, 'page_pointer_band', '4', 'liczebność (połowa) paska ze wskaźnikami stron w pasku nawigacji', 1, 1, :save_time),
				(35, 'send_new_message_report', 'true', 'wysyłanie e-mailem raportów do admina o pojawieniu się nowej wiadomości', 3, 1, :save_time),
				(36, 'black_list_visitors', 'null', 'czarna lista blokowanych adresów IP', 2, 1, :save_time),
				(37, 'email_sender_name', 'Mail Manager', 'nazwa konta e-mailowego serwisu', 1, 1, :save_time),
				(38, 'email_host', 'mail.mvc.net.pl', 'host wysyłania maili', 1, 1, :save_time),
				(39, 'email_port', '587', 'port smtp', 1, 1, :save_time),
				(40, 'email_password', '', 'hasło konta mailingowego', 1, 1, :save_time),
				(41, 'email_sender_address', :email_sender_address, 'adres konta e-mailowego serwisu', 1, 1, :save_time),
				(42, 'email_admin_address', :email_admin_address, 'adres e-mail administratora serwisu', 1, 1, :save_time),
				(43, 'email_report_address', :email_report_address, 'adres e-mail odbiorcy raportów', 1, 1, :save_time),
				(44, 'email_report_subject', 'Raport serwisu', 'temat maila raportującego zdarzenie', 1, 1, :save_time),
				(45, 'email_report_body_1', 'Raport o zdarzeniu w serwisie', 'treść maila rapotującego - część przed zmiennymi', 2, 1, :save_time),
				(46, 'email_report_body_2', '(brak)', 'treść maila rapotującego - część za zmiennymi', 2, 1, :save_time),
				(47, 'email_register_subject', 'Rejestracja w serwisie', 'temat generowanego maila przy rejestracji konta', 1, 1, :save_time),
				(48, 'email_register_body_1', 'Informujemy, że Twoje konto w serwisie zostało poprawnie zarejestrowane. Zostałeś zarejestrowany jako:', 'treść generowanego maila po rejestracji - przed parametrami', 2, 1, :save_time),
				(49, 'email_register_body_2', 'Jako zarejestrowany użytkownik możesz pisać komentarze do artykułów i nimi zarządzać.', 'treść generowanego maila po rejestracji - za parametrami', 2, 1, :save_time),
				(50, 'email_remindpwd_subject', 'Nowe hasło do konta', 'temat generowanego maila z nowym hasłem', 1, 1, :save_time),
				(51, 'email_remindpwd_body_1', 'Na Twoją prośbę przesyłamy Ci nowe hasło logowania.', 'treść generowanego maila z nowym hasłem - przed hasłem', 2, 1, :save_time),
				(52, 'email_remindpwd_body_2', 'Zaloguj się, a następnie zmień hasło na swoje własne.', 'treść generowanego maila z nowym hasłem - za hasłem', 2, 1, :save_time);
			",
			"
