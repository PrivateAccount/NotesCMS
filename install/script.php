	...
	array(
		'fill_data' => array(
			...
			"
				...
				(36, 'email_sender_name', 'Mail Manager', 'nazwa konta e-mailowego serwisu', 1, 1, :save_time),
				(37, 'email_host', 'mail.mvc.net.pl', 'host wysyłania maili', 1, 1, :save_time),
				(38, 'email_port', '587', 'port smtp', 1, 1, :save_time),
				(39, 'email_password', '', 'hasło konta mailingowego', 1, 1, :save_time),
				(40, 'email_sender_address', :email_sender_address, 'adres konta e-mailowego serwisu', 1, 1, :save_time),
				(41, 'email_admin_address', :email_admin_address, 'adres e-mail administratora serwisu', 1, 1, :save_time),
				(42, 'email_report_address', :email_report_address, 'adres e-mail odbiorcy raportów', 1, 1, :save_time),
				(43, 'email_report_subject', 'Raport serwisu', 'temat maila raportującego zdarzenie', 1, 1, :save_time),
				(44, 'email_report_body_1', 'Raport o zdarzeniu w serwisie', 'treść maila rapotującego - część przed zmiennymi', 2, 1, :save_time),
				(45, 'email_report_body_2', '(brak)', 'treść maila rapotującego - część za zmiennymi', 2, 1, :save_time),
				(46, 'email_register_subject', 'Rejestracja w serwisie', 'temat generowanego maila przy rejestracji konta', 1, 1, :save_time),
				(47, 'email_register_body_1', 'Informujemy, że Twoje konto w serwisie zostało poprawnie zarejestrowane. Zostałeś zarejestrowany jako:', 'treść generowanego maila po rejestracji - przed parametrami', 2, 1, :save_time),
				(48, 'email_register_body_2', 'Jako zarejestrowany użytkownik możesz pisać komentarze do artykułów i nimi zarządzać.', 'treść generowanego maila po rejestracji - za parametrami', 2, 1, :save_time),
				(49, 'email_remindpwd_subject', 'Nowe hasło do konta', 'temat generowanego maila z nowym hasłem', 1, 1, :save_time),
				(50, 'email_remindpwd_body_1', 'Na Twoją prośbę przesyłamy Ci nowe hasło logowania.', 'treść generowanego maila z nowym hasłem - przed hasłem', 2, 1, :save_time),
