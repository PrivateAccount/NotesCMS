	...
	array(
		'fill_data' => array(
			...
			"
				...
				(25, 'aside_panel_visible', 'false', 'panel sekcji bocznej strony widoczny', 3, 1, :save_time),
				(26, 'options_panel_border', 'false', 'menu kontekstowe w dedykowanym panelu', 3, 1, :save_time),
				(27, 'articles_pagination_enabled', 'false', 'paginacja artykułów wyświetlanej kategorii włączona', 3, 1, :save_time),
				(28, 'articles_per_page', '4', 'liczba artykułów wyświetlanej kategorii na stronę w paginacji', 1, 1, :save_time),
				(29, 'comments_panel_visible', 'false', 'panel z komentarzami do artykułu widoczny', 3, 1, :save_time),
				(30, 'moderate_comments', 'false', 'wymagane moderowanie komentarzy - widoczne po akceptacji', 3, 1, :save_time),
				(31, 'display_list_rows', '10', 'liczba wierszy listy na jednej stronie', 1, 1, :save_time),
				(32, 'description_length', '50', 'maksymalna długość opisu pozycji na liście znalezionych', 1, 1, :save_time),
				(33, 'page_pointer_band', '4', 'liczebność (połowa) paska ze wskaźnikami stron w pasku nawigacji', 1, 1, :save_time),
				(34, 'send_new_message_report', 'true', 'wysyłanie e-mailem raportów do admina o pojawieniu się nowej wiadomości', 3, 1, :save_time),
