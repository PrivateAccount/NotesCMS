...
class Sites_Model extends Model
{
	...
	public function GetAll()
	{
		...
		try
		{
			$query = 	'SELECT ' . $this->table_name . '.id, main_page, system_page, category_id, title, contents, description, previews,' .
	...
	public function GetOne($id)
	{
		...
		try
		{
			$query =	'SELECT ' . $this->table_name . '.*, category_id, user_login FROM ' . $this->table_name .
						' INNER JOIN users ON users.id = ' . $this->table_name . '.author_id' .
	...
	public function Save($id, $record)
	{
		...
		try
		{
			$query =	'UPDATE ' . $this->table_name .
						' SET main_page = :main_page, system_page = :system_page, title = :title, contents = :contents, description = :description,' .
