	...
	public function Reset_Action()
	{
		if ($this->app->get_acl()->allowed(ADMIN)) // są uprawnienia
		{
			...
			if (isset($_GET['confirm']))
			{
				...
				if ($result) $this->app->get_page()->set_message(MSG_INFORMATION, 'Styl został pomyślnie zresetowany.');
				else $this->app->get_page()->set_message(MSG_ERROR, 'Styl nie został zresetowany.');
